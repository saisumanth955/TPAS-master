...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBox4" ErrorMessage="RequiredField" ForeColor="#FF3300"></asp:RequiredFieldValidator>
